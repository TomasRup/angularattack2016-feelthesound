    ...
    <div class="uk-grid">
        <div class="uk-width-large-1-2">
            <a [routerLink]="['/singledevice']" class="uk-panel uk-panel-hover" data-uk-scrollspy="{cls:'uk-animation-fade'}">
                ...
                Use your phone to monitor your child's sleep. The device will start vibrating and flashing if your baby will start crying. This especially suits people with hearing impairements. <a class="uk-button-link">Go!</a>
            </a>
        </div>
        <div class="uk-width-large-1-2" data-uk-scrollspy="{cls:'uk-animation-fade'}">
            <a [routerLink]="['/modeselectionmultipledevices']" class="uk-panel uk-panel-hover">
                ...
                Monitor your baby remotely. Use one device near your child and another one near each of parents - track the sounds easily. <a class="uk-button-link">Go!</a>
            </a>
        </div>
    </div>
    `
